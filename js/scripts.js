let receitas;
const BASE_URL = "https://mock-api.bootcamp.respondeai.com.br/api/v2/tastecamp";
// const BASE_URL = "http://localhost:4000";

buscarReceitas();

function buscarReceitas() {
  const promessa = axios.get(`${BASE_URL}/receitas`);
...
function buscarReceitaEspecifica(id) {
  ...
  const promessa = axios.get(`${BASE_URL}/receitas/${id}`);
  promessa.then((resp) => {
...
function adicionarReceita() {
  ...
  const promessa = axios.post(`${BASE_URL}/receitas`, novaReceita);
